...
public class HomePage extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/softCreamy.png"))); // NOI18N
    ...
    private void undoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_undoActionPerformed
        int undoCount = 1;
        FileMemento previousMemento = mementoManager.getPreviousMemento(undoCount);
    ...
    if (previousMemento != null) {
        ...
        fileName = "";
        fileExtension = "";
        fileNameLabel.setText("a");
        extensionLabel.setText("b");
